...
const BasicLayout: React.FC<DashBoardProps> = ({route}) => {
  ...
  return (
    <Box>
      <Header open={open} handleToggleDrawer={handleToggleDrawer} drawerwidth={drawerwidth} />
      <Drawer open={open} handleToggleDrawer={handleToggleDrawer} drawerwidth={drawerwidth} />
      <Main open={open}>
        <DrawerHeader />
